...
export const tailwindParse =  (html) => {
    ...
    while(html.indexOf('<a href="https://www.youtube.com/watch?v=') >=  0) {
        ...
        html = html.replace(/<a href="https:\/\/www\.youtube\.com\/watch\?v=.*?<\/a>/, '<iframe className="w-full max-w-lg aspect-video" src="https://www.youtube.com/embed/' + im_data + '" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
    }
    // console.log(text);

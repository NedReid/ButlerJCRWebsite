...
class FreshersFAQ extends React.Component {
    constructor(props) {
        super(props);
        this.state = {FAQ: "waiting", editor: props.admin.freshers, editing: false, category: "freshers", saving: false, nextOrder: 0}
    }
        ...
        return <div>
            {(this.state.FAQ !== "waiting" && this.props.admin !== "waiting" && this.state.saving === false)?
                <div className="relative m-4">
                    ...
                    <div className="mt-2">If you have any questions about Freshers Week, you will likely find answers here!</div>

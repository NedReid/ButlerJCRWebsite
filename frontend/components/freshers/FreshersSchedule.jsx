                ...
                {this.state.editables !== "waiting" && (
                    <div className="relative">
                        ...
                        <div className="text-lg mt-1">
                            Follow this page for up-to-date information on all our Freshers Week
                            activities! For a full list of all our events from {`Freshers'`} Week
                            and beyond, you can also visit our{" "}

...
class SSCHeader extends React.Component {
    ...
    async componentDidMount() {
        this.setState({
            gotImage: await this.checkImage("../../files/sscLogos/" + this.props.ssc._id),
        });
        this.setState({
            editor:
                this.props.username !== "waiting" &&
                this.props.username !== false &&
                this.props.ssc.editors.includes(this.props.username),
        });
    }
        ...
        return (
            ...
            >
                {this.state.editor && this.state.showPencil && (
                    <>
                        <button
                            onClick={() => this.props.editPage(this.props.ssc._id)}
                            className="btn btn-circle absolute top-0 right-0 m-2"
                            onMouseOver={this.handleMouseMiniOver}
                            onMouseOut={this.handleMouseMiniOut}
                        >
                ...
                <div className="flex items-center">
                    <img
                        ...
                        src={
                            this.state.gotImage
                                ? "../../files/sscLogos/" + this.props.ssc._id

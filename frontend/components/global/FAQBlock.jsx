...
class FAQBlock extends React.Component {
    ...
    render() {
        ...
        if (this.props.editing) {
            return (
                <div className="my-2 hover:bg-gray-100" icon="arrow">
                    <div className="p-4 border-l-4 border-gray-400">
                        <input
                            className="rounded border-2 border-slate-500 text-xl font-semibold w-full"
                            name="question"
                            type="text"
                            defaultValue={this.state.q.question}
                    ...
                    <div className="pb-4 px-4 bg-white border-l-4 border-gray-200">
                        <div className="mt-2 w-full h-full">
                            <InPlaceEditor
                                ...
                                initialValue={this.state.q.answer}
                                onUpdate={this.updateAnswer}
                                key={this.state.q._id}
                            />
                        </div>
                        <br />
                        <div className="flex">
                            <button
                                ...
                                className="bg-amber-400 rounded p-2 hover:cursor-pointer transition hover:bg-amber-600 modal-button"
                            >
                                Delete FAQ
                            </button>
                            <div
                                className={
                                    ...
                                    (upDisabled
                                        ? " text-gray-200"
                                        : " hover:bg-gray-200 text-gray-400 hover:text-gray-600 hover:cursor-pointer")
                                }
                                onClick={
                                    upDisabled
                                        ? () => {}
                            ...
                            >
                                <AiOutlineArrowUp className="h-full my-auto w-full mx-auto" />
                            </div>
                            <div
                                className={
                                    "h-10 w-10 rounded-full ml-1 text-xl font-semibold transition-all duration-300 p-1" +
                            ...
                            >
                                <AiOutlineArrowDown className="h-full my-auto w-full mx-auto" />
                            </div>
                        </div>
                    </div>
                    <Modal open={this.state.modelOpen}>
                        ...
                        <Modal.Body>
                            <p className="py-4">
                                Are you sure you want to remove this FAQ Question?{" "}
                                {this.state.q.question}
                            </p>
                        </Modal.Body>
                        <Modal.Actions>
                            <label onClick={this.deleteFAQ} className="btn">
                                Yes
                            </label>
                            <label
                                onClick={() => {

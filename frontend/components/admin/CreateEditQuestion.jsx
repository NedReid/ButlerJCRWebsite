                ...
                <div className="my-2 p-2 rounded border-2 border-amber-500 flex flex-col">
                    <label className="flex">
                        ...
                        <input
                            ...
                            name="questionText"
                            type="text"
                            defaultValue={this.state.qu.questionText}
                            onChange={(event) => this.handleChange(event, "questionText")}
                        />
                    </label>
                    ...
                    <span>
                        <label>
                            <input
                                defaultChecked={
                                    this.state.qu.questionType === questionTypeEnum.text
                                }
                                onChange={(event) => this.handleNumChange(event, "questionType")}
                                type="radio"
                                id="ts1"
                                name={this.props._id + this.state.qu.id + "questionType"}
                        ...
                        <label className="ml-4">
                            <input
                                defaultChecked={
                                    this.state.qu.questionType === questionTypeEnum.number
                                }
                                onChange={(event) => this.handleNumChange(event, "questionType")}
                                type="radio"
                                id="ts3"
                                name={this.props._id + this.state.qu.id + "questionType"}
                                value={questionTypeEnum.number}
                            />
                            Number
                        </label>
                    </span>
                        ...
                        <>
                            <label>
                                ...
                                <input
                                    ...
                                    name="noTickets"
                                    type="number"
                                    defaultValue={this.state.qu.data.length}
                                ...
                                return (
                                    <label className="flex" key={index}>
                                        ...
                                        <input
                                            ...
                                            name="questionText"
                                            type="text"
                                            defaultValue={this.state.qu.data[index]}
                                            key={this.props._id + this.state.qu.id + "o" + index}
                                            onChange={(event) =>
                                                this.updateOptionText(event, index)
                                            }
                                        />
                                    </label>
                                );

...
class CreateEditCalendarEvent extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                {" "}
                <div className="my-2 p-2 border-gray-500 border-l-2 flex flex-col">
                    <label>
                        {" "}
                        Event title:
                        <input
                    ...
                    <select
                        ...
                        onChange={(event) => this.handleNumChange(event, "category")}
                        className="select select-bordered w-full max-w-xs mb-2"
                    >
                        {[...Array(7)].map((x, i) => {
                            return (
                                <option value={i} key="category">
                                    {getCalendarEventTypeName(i)}
                                </option>
                            );
                        })}
                    </select>
                    ...
                    <label className="flex items-center">
                        ...
                        <Checkbox
                            ...
                            onChange={(event) => this.handleBoolChange(event, "allDay")}
                        ></Checkbox>
                    </label>
                    ...
                    <label>
                        ...
                        <br />
                        <input
                            className="rounded border-2 border-slate-500 w-full max-w-2xl"
                            maxLength="64"
                            name="shortDescription"
                            type="text"
                            defaultValue={this.state.event.shortDescription}
                            onChange={(event) => this.handleChange(event, "shortDescription")}
                        />
                    </label>
                    <div className="text-sm italic mb-2">
                        Max 64 Characters - Short description of event
                    </div>

                    <label> Event Description:</label>
                    <div className="p-1 rounded border-2 border-slate-500 mb-2">
                        <TextEditor
                            initialValue={this.state.event.description}
                    ...
                    <div className="text-sm italic mb-2">
                        Write {`"TBC"`} or leave blank if unknown
                    </div>
                    ...
                    <div className="text-sm italic mb-2">
                        Optional: Link to booking or more information.
                    </div>
                    ...
                    <label className="flex items-center">
                        ...
                        <Checkbox
                            className="ml-2"
                            defaultChecked={this.state.event.visible}

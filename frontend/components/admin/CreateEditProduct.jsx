        ...
        return <> <div className="my-2 p-2 rounded border-2 border-amber-500 flex flex-col">
            ...
            <label> Product name:
                <input className=" ml-2 mb-2 rounded border-2 border-slate-500"
                    name="name" type="text" defaultValue={this.state.product.name} onChange={(event) => this.handleChange(event, "name")}/>
            </label>

            <label> Product price:
                <input className=" ml-2 mb-2 rounded border-2 border-slate-500" name="noTickets"
                       type="number" defaultValue={this.state.product.price} onChange={(event) => this.handleNumChange(event, "price")}
                       onKeyDown={(event) => {

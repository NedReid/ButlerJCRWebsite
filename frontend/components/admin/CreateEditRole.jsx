                ...
                <div className="my-2 p-2 rounded border-2 border-amber-500 flex flex-col">
                    ...
                    <label>
                        ...
                        <input
                            ...
                            name="slug"
                            type="text"
                            defaultValue={this.state.role.slug}
                    ...
                    <select
                        name="e_meeting"
                        defaultValue={this.state.role.e_meeting}
                        onChange={(event) => this.handleNumChange(event, "e_meeting")}
                        className="select select-bordered w-full max-w-xs"
                    >
                        {Object.values(meetingEnum).map((meeting) => {
                            return (
                                <option value={meeting} key="roleType">
                    ...
                    <label>
                        ...
                        <input
                            ...
                            name="e_seats"
                            type="number"
                            defaultValue={this.state.role.e_seats}
                            onChange={(event) => this.handleNumChange(event, "e_seats")}
                            onKeyPress={(event) => {
                    ...
                    <label>
                        ...
                        <input
                            ...
                            name="e_type"
                            type="text"
                            defaultValue={this.state.role.e_type}
                            onChange={(event) => this.handleChange(event, "e_type")}
                        />
                    </label>

                    <label>Election Method:</label>
                    <select
                        defaultValue={this.state.role.e_method}
                        onChange={(event) => this.handleNumChange(event, "e_method")}
                        className="select select-bordered w-full max-w-xs"
                    >
                        {Object.values(methodEnum).map((method) => {
                            return (
                                <option value={method} key="roleType">
                                    {methodName(method)}
                                </option>
                            );
                        })}
                    ...
                    <select
                        name="category"
                        defaultValue={this.state.role.category}

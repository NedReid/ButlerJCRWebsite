                ...
                <div className="my-2 p-2 rounded border-2 border-amber-500 flex flex-col">
                    <label>
                        ...
                        <input
                            ...
                            name="name"
                            type="text"
                            defaultValue={this.state.officer.name}
                    ...
                    <label>
                        ...
                        <input
                            ...
                            name="username"
                            type="text"
                            defaultValue={this.state.officer.username}
                    ...
                    {this.state.currentCategory !== "" && (
                        <select
                            ...
                            name="category"
                            defaultValue={this.state.officer.role}
                    ...
                    <select
                        name="election_meeting"
                        defaultValue={this.state.officer.election_meeting}
                        onChange={(event) => this.handleNumChange(event, "election_meeting")}
                        className="select select-bordered w-full max-w-xs"
                    >
                        {Object.values(meetingEnum).map((meeting) => {
                            return (
                                <option value={meeting} key="election_meeting">
                    ...
                    <label>
                        ...
                        <input
                            ...
                            name="election_year"
                            type="number"
                            defaultValue={this.state.officer.election_year}
                            onChange={(event) => this.handleNumChange(event, "election_year")}
                            onKeyPress={(event) => {
                    ...
                    <span>
                        <label>
                            <input
                                defaultChecked={this.state.officer.current === false}
                                onChange={(event) => this.handleBoolChange(event, "current")}
                                type="radio"
                                name={this.state.officer._id + "current"}
                                value={false}
                            />
                            False
                        </label>
                        <label className="ml-2">
                            <input
                                defaultChecked={this.state.officer.current === true}
                                onChange={(event) => this.handleBoolChange(event, "current")}
                                type="radio"
                                name={this.state.officer._id + "current"}
                                value={true}

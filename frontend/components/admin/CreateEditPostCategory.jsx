    ...
    render() {
        ...
        return (
            <>
                ...
                <div className="my-2 p-2 rounded border-2 border-amber-500 flex flex-col">
                    <label>
                        ...
                        <input
                            ...
                            name="name"
                            type="text"
                            defaultValue={this.state.postCategory.name}
                    ...
                    <label>
                        ...
                        <input
                            ...
                            name="noEditors"
                            type="number"
                            defaultValue={this.state.postCategory.editors.length}
                        ...
                        return (
                            <label className="flex" key={index}>
                                ...
                                <input
                                    ...
                                    name="questionText"
                                    type="text"
                                    defaultValue={this.state.postCategory.editors[index]}
                                    key={this.state.postCategory._id + "editor" + index}
                ...
                {this.props.postCategory !== undefined && (
                    <label
                        htmlFor="my-modal"

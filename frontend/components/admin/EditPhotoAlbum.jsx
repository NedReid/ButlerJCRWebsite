...
class EditPhotoAlbum extends React.Component {
    ...
    render() {
        ...
        return <> <div className="my-2 p-2 rounded border-2 border-amber-500 flex flex-col">
            ...
            <div><b>WARNING:</b> Editing the album name will cause all previously shared links to the album to break. Think carefully before editing the album name.</div>
            <label> Album Name:
                <input className=" ml-2 mb-2 rounded border-2 border-slate-500"
                    name="name" type="text" defaultValue={this.state.photoAlbum.name} onChange={(event) => this.handleChange(event, "name")}/>
            </label>
            <label> Album Date:
                <DateTimePicker disableCalendar={true} disableClock={true} className="ml-2 mb-2"
                                minDate={new Date(2000,1)} maxDate={new Date(3000,1)}
                                name="date" value={this.state.photoAlbum.date} onChange={this.handlePhotoAlbumDate}/>
            </label>
            ...
            <div className="modal">
                <div className="modal-box">
                    ...
                    <p className="py-4">Are you sure you want to remove this photo album? This will also delete all photos in the album from the website.</p>

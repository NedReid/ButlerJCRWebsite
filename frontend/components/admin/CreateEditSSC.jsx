                ...
                <div className="my-2 p-2 rounded border-2 border-amber-500 flex flex-col">
                    ...
                    <label>
                        ...
                        <input
                            ...
                            name="noEditors"
                            type="number"
                            defaultValue={this.state.SSC.editors.length}
                        ...
                        return (
                            <label key={index} className="flex">
                                ...
                                <input
                                    ...
                                    name="questionText"
                                    type="text"
                                    defaultValue={this.state.SSC.editors[index]}
                                    key={this.state.SSC._id + "editor" + index}
                    ...
                    <span>
                        <label>
                            <input
                                defaultChecked={this.state.SSC.type === SSCEnum.society}
                                onChange={(event) => this.handleNumChange(event, "type")}
                                type="radio"
                                id="ts1"
                                name={this.state.SSC._id + "SSCType"}
                                value={SSCEnum.society}
                            />
                            Society
                        </label>
                        <label className="ml-4">
                            <input
                                defaultChecked={this.state.SSC.type === SSCEnum.sport}
                                onChange={(event) => this.handleNumChange(event, "type")}
                                type="radio"
                                id="ts2"
                                name={this.state.SSC._id + "SSCType"}
                        ...
                        <label className="ml-4">
                            <input
                                defaultChecked={this.state.SSC.type === SSCEnum.committee}
                                onChange={(event) => this.handleNumChange(event, "type")}
                                type="radio"
                                id="ts3"
                                name={this.state.SSC._id + "SSCType"}
                                value={SSCEnum.committee}
                            />
                            Committee
                        </label>
                    </span>

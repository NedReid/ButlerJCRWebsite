        ...
        return (
            <>
                <div
                    ...
                    className="group relative hover:cursor-pointer w-48 h-48"
                >
                    <img
                        className="w-full object-contain absolute"
                        src={
                            candidate.promotionalImage !== undefined &&
                            candidate.promotionalImage.length > 0
                                ? "../../" + candidate.promotionalImage
                                : "../../media/global/JCRLogo.png"
                        }
                    ></img>
                    <div className="bg-opacity-0 transition group-hover:block absolute h-full w-full group-hover:bg-opacity-20 bg-slate-900"></div>
                ...
                >
                    <Modal.Header>
                        {candidate.name} For {rName}
                    </Modal.Header>
                    <Modal.Body className="h-max">
                        {candidate.poster !== undefined && candidate.poster.length > 0 && (
                            <Collapse className={"group bg-slate-100"} checkbox={true} icon="arrow">
                                <Collapse.Title className="group-hover:bg-slate-200 text-xl font-semibold">
                                    Poster
                                </Collapse.Title>
                                <Collapse.Content className="bg-slate-50">
                                    <img
                                        ...
                                        src={
                                            candidate.poster !== undefined &&
                                            candidate.poster.length > 0
                                                ? "../../" + candidate.poster
                                                : "../../media/global/JCRLogo.png"
                                        }
                                    ></img>
                        ...
                        {(candidate.manifesto !== undefined && candidate.manifesto.length > 0) !==
                            undefined && (
                            <Collapse className={"group bg-slate-100"} checkbox={true} icon="arrow">
                                <Collapse.Title className="group-hover:bg-slate-200 text-xl font-semibold">
                                    Manifesto
                        ...
                        {(candidate.video !== undefined && candidate.video.length > 0) !==
                            undefined && (
                            <Collapse className={"group bg-slate-100"} checkbox={true} icon="arrow">
                                <Collapse.Title className="group-hover:bg-slate-200 text-xl font-semibold">
                                    Video

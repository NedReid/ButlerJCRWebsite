                    ...
                    <div className="sticky top-36 grid grid-cols-2 justify-items-center md:block text-center md:text-left">
                        ...
                        <div>
                            ...
                            <p className="font-semibold">
                                {meetingToName(this.state.role.e_meeting)}
                            </p>
                            <br />
                        </div>
                        <div>
                            ...
                            <div>
                                <ElectionMethodModal
                                    text_props="hover:underline font-semibold"
                                    text={methodName(this.state.role.e_method)}
                                    method={this.state.role.e_method}
                                />
                            </div>
                            <br />
                        </div>
                ...
                <div className="">
                    {this.state.admin && (
                        <div className="bg-slate-500 text-white w-full h-12 pl-2 flex">
                            ...
                            <button
                                className={
                                    "flex-grow-0 flex-shrink-0 w-12 h-12 bg-slate-600 px-1 ml-1 transition hover:bg-slate-700 swap " +
                    ...
                    {this.state.editing && (
                        <div className="bg-slate-600 text-white w-full h-24 p-4">
                            <label>
                                {" "}
                                Role Description:
                                <input
                                    className=" ml-2 mb-2 rounded border-2 border-slate-500 text-black"
                                    name="name"
                                    type="text"
                                    defaultValue={this.state.role.desc}
                            ...
                            <span>
                                <label>
                                    <input
                                        defaultChecked={this.state.role.visible === false}
                                        onChange={(event) =>
                                            this.handleBoolChange(event, "visible")
                                        }
                                        type="radio"
                                        name={this.state.role._id + "visible"}
                                        value={false}
                                    />
                                    False
                                </label>
                                <label className="ml-2">
                                    <input
                                        defaultChecked={this.state.role.visible === true}
                                        onChange={(event) =>
                                            this.handleBoolChange(event, "visible")
                                        }
                                        type="radio"
                    ...
                    <div className="md:pl-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 justify-between">
                        ...
                        <div className="pl-4 md:pl-0 col-span-2 p-2 lg:col-span-3 mt-2">
                            {this.state.editing ? (
                                <div className="border-2 rounded">
                                    <InPlaceEditor
                                        ...
                                        initialValue={this.state.role.page}
                            ...
                            <Collapse className="group" checkbox={true} icon="arrow">
                                <Collapse.Title className="group-hover:bg-slate-100 text-3xl font-semibold">
                                    Standing Orders
                                </Collapse.Title>

...
class RoleHeader extends React.Component {
    ...
    async componentDidMount() {
        this.setState({gotImage: await this.checkImage("../../files/uploaded/roles/" + this.props.role._id)})
    }
    ...
    render() {
        return <div onClick={this.mainClick}  className="hover:cursor-pointer hover:bg-slate-50 active:bg-slate-200 hover:shadow hover:animate-pingOnce relative border-2 p-2 w-11/12 h-36 sm:h-48 my-2" onMouseOver={this.handleMouseOver} onMouseOut={this.handleMouseOut}>
            ...
            <div className="flex items-center">
                <img className="w-16 h-16 sm:w-24 sm:h-24 object-contain" src={this.state.gotImage? "../../files/uploaded/roles/" + this.props.role._id : "../../media/global/JCRLogo.png"} />

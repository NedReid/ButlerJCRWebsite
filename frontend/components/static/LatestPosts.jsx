            ...
            <div className="flex flex-col w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center bg-gray-50">
                    {this.state.posts.map((post, index) => {
                        ...
                        return <div className={"w-11/12 my-4 bg-white border-2 border-gray-400 rounded-lg transition-all ease-in-out duration-200 hover:translate-y-1 hover:brightness-90 hover:cursor-pointer" + (index >= 3? " lg:hidden xl:inline": "")}
...
export default function(props) {
    ...
    return <LatestPosts {...props} navigate={navigate} />;
}
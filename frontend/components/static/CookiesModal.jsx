        ...
        if (this.state.open) {
            return <div className="bg-gray-700 text-white flex xs:h-24 sm:h-20 md:h-16">
                <div className="p-2 grow text-sm"><div>We use cookies to provide core functionality.
                    Please read our <Link to="/cookies" className="underline hover:brightness-75">Cookies Policy</Link> for more information.</div>
                    <div className="mt-0.5">This website is in <span className="font-semibold">Beta</span>. If you encounter any issues, please use our <Link to="/feedback" className="underline hover:brightness-75">website feedback form</Link>.</div>

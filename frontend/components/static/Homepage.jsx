        ...
        return <div>
            ...
            <div className="mt-8 sm:flex p-1">
                <div className="w-1/2 sm:w-1/3 translate-x-1/2 sm:translate-x-0 sm:mr-4 mb-2">
                    ...
                    <div className="w-full text-center mt-1 font-semibold text-grey-800">Daniel Stuart</div>
                ...
                <div className="text-sm text-grey-900 w-full sm:w-2/3">
                    ...
                    We aim to offer a range of high-quality extra-curricular activities including sports, societies, committees, and events such as Winter and Summer Ball, Josephine Butler Charity Showcase,
                    and Butler Day. We’re also immensely proud of our students’ continued academic achievements and contributions to the wider university. <br/><br/>
            ...
            <div className="mt-8 sm:flex p-1">
                ...
                <div className="text-sm text-grey-900 w-full sm:w-2/3">
                    Hi everyone, <br/><br/>
                    My name is Arman Huq and I am your Financial and Community Support Officer (FACSO) for this year.
                    I am one of the two JCR sabbatical officers and I’ll be working alongside Daniel, the JCR president to deliver an exceptional experience to all our students and JCR members.  <br/><br/>
                ...
                <div className="w-1/2 sm:w-1/3 translate-x-1/2 sm:translate-x-0 sm:ml-4 mb-2">
                    ...
                    <div className="w-full text-center mt-1 font-semibold text-grey-800">Arman Huq</div>

        ...
        return <div>
            ...
            <div>
                {this.state.posts.map((post) => {
                    ...
                    return <div key={post._id} className="grid grid-cols-3 gap-4 bg-gray-200 mb-4 mx-4 hover:translate-x-3 transition-transform ease-in-out duration-200 hover:brightness-90 hover:cursor-pointer"

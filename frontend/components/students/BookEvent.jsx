...
class BookEventComponent extends React.Component {
    constructor(props) {
        ...
        this.state = {
            eventBooking: new eventBookingModel(),
            eventId: eventId,
            completed: false,
            loading: false,
        };
    ...
    handleGroupSize = (event) => {
        ...
        while (gs > this.state.eventBooking.individualAnswers.length) {
            this.state.eventBooking.individualAnswers.push(
                new individualAnswerModel(false, this.state.event.questions.length),
            );
        }
        while (gs < this.state.eventBooking.individualAnswers.length) {
    ...
    render() {
        if (
            ...
            this.state.event.groupSizes !== undefined &&
                        ...
                        <span className="flex">
                            {this.state.event.groupSizes["1"] && (
                                <label className="label">
                                    <input
                                        className="radio-sm hover:scale-105 transition"
                                        name="groupSize"
                                        ...
                                        value={1}
                                    />
                                    <span className="label-text ml-1">1</span>
                                </label>
                            )}
                            {this.state.event.groupSizes["2"] && (
                                <label className="ml-2 label">
                                    <input
                                        ...
                                        value={2}
                                    />
                                    <span className="label-text ml-1">2</span>
                                </label>
                            )}
                            {this.state.event.groupSizes["3"] && (
                                <label className="ml-2 label">
                                    <input
                                        ...
                                        value={3}
                                    />
                                    <span className="label-text ml-1">3</span>
                                </label>
                            )}
                            {this.state.event.groupSizes["4"] && (
                                <label className="ml-2 label">
                                    <input
                                        ...
                                        value={4}
                                    />
                                    <span className="label-text ml-1">4</span>
                                </label>
                            )}
                            {this.state.event.groupSizes["5"] && (
                                <label className="ml-2 label">
                                    <input
                                        ...
                                        value={5}
                                    />
                                    <span className="label-text ml-1">5</span>
                                </label>
                            )}
                            {this.state.event.groupSizes["6"] && (
                                <label className="ml-2 label">
                                    <input
                                        ...
                                        value={6}
                                    />
                                    <span className="label-text ml-1">6</span>
                                </label>
                            )}
                            {this.state.event.groupSizes["8"] && (
                                <label className="ml-2 label">
                                    <input
                                        ...
                                        value={8}
                                    />
                                    <span className="label-text ml-1">8</span>
                                </label>
                            )}
                            {this.state.event.groupSizes["10"] && (
                                <label className="ml-2 label">
                                    <input
                                        ...
                                        value={10}
                                    />
                                    <span className="label-text ml-1">10</span>
                                </label>
                            )}
                            {this.state.event.groupSizes["12"] && (
                                <label className="ml-2 label">
                                    <input
                                        ...
                                        value={12}
                                    />
                                    <span className="label-text ml-1">12</span>
                                </label>
                            )}
                        </span>

                        {this.state.eventBooking.individualAnswers.map(
                                    ...
                                    <div key={index} className="flex flex-col">
                                        ...
                                        <label>
                                            ...
                                            <input
                                                ...
                                                name="name"
                                                type="text"
                                                defaultValue={individualAnswer.name}
                                                onChange={(event) =>
                                                    this.handleChange(event, "name", index)
                                                }
                                            />
                                        </label>
                                        <label>
                                            {" "}
                                            CIS Code <i>(use personal email if guest):</i>
                                            <input
                                                className=" ml-2 mb-2 rounded border-2 border-slate-500"
                                                name="name"
                                                type="text"
                                                defaultValue={individualAnswer.cis}
                                                onChange={(event) =>
                                                    this.handleChange(event, "cis", index)
                                                }
                                            />
                                        </label>
                                            ...
                                            return (
                                                <div key={index2} className="flex flex-col">
                                                    ...
                                                    {question.questionType ===
                                                        ...
                                                        <div>
                                                            <textarea
                                                                className="w-96 textarea mb-2 rounded border-2 border-slate-500"
                                                                placeholder=""
                                                                onChange={(event) =>
                                                                    this.handleQuestion(
                                                                        event,
            ...
            return <div>Your booking is confirmed</div>;
        } else {

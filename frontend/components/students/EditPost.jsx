                ...
                <>
                    ...
                    <div className="my-2 p-2 rounded border-2 border-amber-500 flex flex-col">
                        ...
                        <span>
                            <label>
                                <input
                                    defaultChecked={this.state.post.visible === false}
                                    onChange={(event) => this.handleBoolChange(event, "visible")}
                                    type="radio"
                                    name={this.state.post._id + "visible"}
                                    value={false}
                                />
                                False
                            </label>
                            <label className="ml-2">
                                <input
                                    defaultChecked={this.state.post.visible === true}
                                    onChange={(event) => this.handleBoolChange(event, "visible")}
                                    type="radio"
                                    name={this.state.post._id + "visible"}
                                    value={true}
                        ...
                        <div className="p-1 rounded border-2 border-slate-500">
                            <TextEditor
                                initialValue={this.state.post.post}

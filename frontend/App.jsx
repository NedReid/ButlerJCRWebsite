...
import BookableSpaces from "./components/static/BookableSpaces";
import StudySpaces from "./components/static/StudySpaces";
...
class App extends React.Component {
    ...
    MainRoutes = () => (
        <Routes>
            ...
            <Route path="/bookable-spaces" element={<BookableSpaces />} />
